...
def get_notifications_to_send():
    ...
    return (
        ...
        (True, const.NOTIFICATION_NAME_STATUS, "user2", "1 status for user2"),
        (True, const.NOTIFICATION_NAME_STATUS, "user2", "2 status for user2"),
        (False, const.NOTIFICATION_NAME_STATUS, "user2", "3 status for user2"),
        (False, const.NOTIFICATION_NAME_STATUS, "user2", "4 status for user2"),
        (True, const.NOTIFICATION_NAME_NEWS, "user2", "1 news for user2"),
        (False, const.NOTIFICATION_NAME_NEWS, "user2", "2 news for user2"),
        (True, const.NOTIFICATION_NAME_MARKETING, "user2", "1 marketing for user2"),
        (True, const.NOTIFICATION_NAME_MARKETING, "user2", "2 marketing for user2"),
        (False, const.NOTIFICATION_NAME_MARKETING, "user2", "3 marketing for user2"),
    )
